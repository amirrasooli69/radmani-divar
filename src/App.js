...
function App({
    ...
    const getApi =()=>{
        // Axios.get('http://rooocket.org/api/products'
    ...
    return (
        <>
            <BrowserRouter>
                <Switch>
                <Redirect exact from='https://radmanisho.ir/radman/requirements/site/' Link='https://radmanisho.ir/' />
                <Route path = "/" render = {(props) => <Wrapper {...props}/>} / >
                </Switch>
            </BrowserRouter>
        </>
    )
