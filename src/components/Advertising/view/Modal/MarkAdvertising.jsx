...
export default function MarkAdvertising() {
    return (
        <>
            ...
            <Modal.Body>
               <div className="my-2">
                   با ورود به حساب کاربری، آگهی‌هایی که نشان می‌کنید در حساب کاربری‌ شما ذخیره خواهند شد و از طریق همه دستگاه‌هایی که به وسیله آن‌ها وارد حساب کاربری خود در رادمانی شو شوید در دسترس خواهند بود.
               </div>
